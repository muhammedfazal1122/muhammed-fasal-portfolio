...
const ARTICLES = [
  {
    title: "From Computer Science to Production Systems",
    excerpt:
      "My journey from a BSc Computer Science student to a production-ready Full Stack Developer through intensive bootcamp training and real-world projects.",
    category: "Journey",
    readTime: "5 min read",
  ...
  {
    title: "Building Real-Time Systems with Django & WebSockets",
    excerpt:
      "How I engineered real-time messaging infrastructure using Django Channels, Redis, and WebSockets to achieve sub-100ms concurrency in production.",
    category: "Tech",
    readTime: "8 min read",
  ...
  {
    title: "Scaling Full Stack Apps on AWS with Docker",
    excerpt:
      "Lessons learned while deploying and optimizing full stack applications using Docker, AWS EC2, Nginx, and Cloudflare for high performance and reliability.",
    category: "Tech",
    readTime: "6 min read",
...
export default function Blog() {
  ...
  return (
    <section
      ...
      id="blog"
    >
      {/* Background Ambience (disabled on mobile) */}
